...
export const defaultVendors: VendorConfig[] = [
  ...
  // GeekAI 聚合平台配置
  {
    ...
    models: [
      ...
      { name: 'Doubao Seedream 5.0', type: 'image', modelName: 'doubao-seedream-5-0', mode: ['text', 'singleImage', 'multiReference'] },
      { name: 'Doubao Seedream 4.5', type: 'image', modelName: 'doubao-seedream-4-5', mode: ['text', 'singleImage', 'multiReference'] },
      // 视频模型
      {
        name: 'Sora 2',
        type: 'video',
