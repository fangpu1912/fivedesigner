...
## 4. 黄金节奏（15秒镜头组控秒数）
- 每组15秒：开场2-3秒建空间→中段8-10秒推冲突→收尾2-3秒留钩子
- 第1组（0-15秒）：钩子开场，核心矛盾显现
- 第2组（15-30秒）：压抑加码，情绪蓄力
- 第3组（30-45秒）：爽点爆发/反转炸裂
- 第4组（45-60秒）：余波收束+悬念钩子
...
| \`keyEvents[0]\` | 3-15秒 | 起：outline 开头1/4的节点提取（首个15秒镜头组） |
| \`keyEvents[1]\` | 15-30秒 | 承：outline 中段的节点提取（第2个镜头组） |
| \`keyEvents[2]\` | 30-45秒 | 转：outline 高潮段的节点提取（第3个镜头组） |
| \`keyEvents[3]\` | 45-60秒 | 合：outline 结尾的节点提取（第4个镜头组） |
| \`visualHighlights\` | 全程 | 按 outline 叙事顺序排列的标志性镜头 |
| \`endingHook\` | 最后3秒 | outline 之后的悬念延伸 |
