...
场景：{"name":"场景名（2-6字地点/环境名，如：咖啡馆、主角家、街角，禁止描述性内容）","description":"场景简单描述","prompt":"场景描述（视角、时间段、天气、地理位置、环境元素、材质、颜色、光线、色调），附加结构限定（高空俯瞰图、前视图、左视图、后视图,2×2网格排列,建筑结构、材质、色调、光线一致,严禁出现人物）"}
